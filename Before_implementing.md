...
0. [Flaxia 用語集](README.md#flaxia-用語集)
1. [必要なソフトウェアのインストール](README.md#1-必要なソフトウェアのインストール)
2. [Git の使い方](README.md#2-git-の使い方)
3. [opencode の入れ方](README.md#3-opencode-の入れ方)
4. [プロジェクトのセットアップ](README.md#4-プロジェクトのセットアップ)
5. [開発サーバーの起動](README.md#5-開発サーバーの起動)
6. [テストの仕方](README.md#6-テストの仕方)
7. [ビルドの仕方](README.md#7-ビルドの仕方)
8. [文法チェック・型チェック・エラー対応](README.md#8-文法チェック型チェックエラー対応)
9. [フロントエンドコード全解説](README.md#9-フロントエンドコード全解説)
10. [翻訳（i18n）の追加方法](README.md#910-翻訳i18nの追加方法)
11. [データベースマイグレーションの追加方法](README.md#911-データベースマイグレーションの追加方法)
12. [依存関係の追加方法](README.md#912-依存関係の追加方法)
13. [コード規約・命名規則](README.md#913-コード規約命名規則)
14. [CSS の設計思想](README.md#914-css-の設計思想)
15. [デバッグのコツ](README.md#915-デバッグのコツ)
16. [知っておくべき重要コンセプト](README.md#916-知っておくべき重要コンセプト)
17. [参考リンク](README.md#参考リンク)
